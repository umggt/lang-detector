CREATE TABLE IDIOMAS (
	...
	LETRAS INTEGER NOT NULL, -- Total de letras registradas en el idioma, igual a la suma de cantidad en idiomas_letras
...
CREATE INDEX DOCUMENTOS_HASHES ON DOCUMENTOS (HASH);